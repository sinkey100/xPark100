...
return [
    ...
    'connections'     => [
        ...
        'chuanyou'   => [
            ...
            // 服务器地址
            'hostname'        => env('chuanyou.hostname', '127.0.0.1'),
            // 数据库名
            'database'        => env('chuanyou.database', ''),
            // 用户名
            'username'        => env('chuanyou.username', ''),
            // 密码
            'password'        => env('chuanyou.password', ''),
            // 端口
            'hostport'        => env('chuanyou.hostport', ''),
            // 数据库连接参数
            'params'          => [],
            // 数据库编码默认采用utf8mb4
            'charset'         => env('chuanyou.charset', 'utf8mb4'),
            // 数据库表前缀
            'prefix'          => env('chuanyou.prefix', 'i_'),
