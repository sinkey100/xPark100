...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    month: [buildValidatorData({ name: 'required', title: t('xpark.tidy.month') })],
    channel_id: [buildValidatorData({ name: 'required', title: t('xpark.tidy.channel_id') })],
    money: [buildValidatorData({ name: 'required', title: t('xpark.tidy.money') })],
    create_time: [buildValidatorData({ name: 'date', title: t('xpark.tidy.create_time') })],
    update_time: [buildValidatorData({ name: 'date', title: t('xpark.tidy.update_time') })],
})
</script>
