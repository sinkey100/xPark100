            ...
            >
                ...
                >
                    ...
                    <el-row :gutter="15">
                        ...
                        <el-col :span="6">
                            <el-input v-for="(item, index) in baTable.form.items?.rate" :key="'domain_rate_' + index"
                        ...
                        <el-col :span="6">
                            <el-input v-for="(item, index) in baTable.form.items?.exchange"
                                      :key="'domain_exchange_' + index" v-model="baTable.form.items!.exchange[index]"/>
                        </el-col>
                    </el-row>
                    ...
                    <el-date-picker
                        ...
                        placeholder="选择月份"
                    />
                    <el-button type="primary" class="btn-generate" :loading="isGenerate" @click="generate">生成账单
                    </el-button>
...
const open = () => {
    ...
    baTable.form.extend!.domainList.forEach((item, index) => {
        baTable.form.items?.domains.push(item.domain)
